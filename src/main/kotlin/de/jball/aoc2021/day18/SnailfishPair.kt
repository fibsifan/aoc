...
class SnailfishPair(
    ...
    private fun rebuildTree(node: SnailfishPair, explosionPoints: Triple<SnailfishInt?, SnailfishPair, SnailfishInt?>): SnailfishPair {
    ...
    private fun findExplosionPoints(): Triple<SnailfishInt?, SnailfishPair, SnailfishInt?> {
        val (leftNumber, explodingPair, rightNumber) = findExplosionPoints(this,
            Triple(null as SnailfishInt?, null as SnailfishPair?, null as SnailfishInt?))

        return Triple(leftNumber, explodingPair!!, rightNumber)
    }

    private fun findExplosionPoints(node: SnailfishPair, state: Triple<SnailfishInt?, SnailfishPair?, SnailfishInt?>): Triple<SnailfishInt?, SnailfishPair?, SnailfishInt?> {
        ...
        if (explodingPair != null) {
            ...
            if (node.left is SnailfishInt) {
                return Triple(leftNumber, explodingPair, node.left as SnailfishInt)
            } else {
            ...
            if (node.right is SnailfishInt) {
                return Triple(leftNumber, explodingPair, node.right as SnailfishInt)
            } else {
            ...
            val leftState = if (node.left is SnailfishInt) {
                Triple(node.left as SnailfishInt, null, null)
            } else {
            ...
            return if (leftState.second != null && leftState.third != null) {
                ...
                Triple(leftState.first, leftState.second, node.right as SnailfishInt)
            } else if (node.right is SnailfishInt) {
                Triple(node.right as SnailfishInt, null, null)
            } else {
