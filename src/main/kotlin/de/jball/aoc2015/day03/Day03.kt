...
class Day03(test: Boolean = false) : AdventOfCodeDay<Int>(test, 4, 3) {
	...
	override fun part1(): Int {
		return directions.runningFold(Coordinate(0, 0)) { position, direction ->
			position + direction
		}.toSet().size
	}

	override fun part2(): Int {
		return directions.windowed(2, 2)
			.runningFold(listOf(Coordinate(0, 0), Coordinate(0, 0))) { positions, directions ->
